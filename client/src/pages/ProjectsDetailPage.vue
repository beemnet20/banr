<template>
    <q-page class="q-pa-md">
        <div class="text-h6 q-ma-md">Project: {{ project.project_name }}</div>
        <div class="row">
            <div class="col-4">
        ...
        <q-form @submit="onSubmit" class="q-gutter-md q-mt-md">
            ...
            <div class="row q-mt-none">
                <q-input filled class=" col q-ma-sm" type="text-area" v-model="project.notes" label="Notes" :disable="isLoading"/>

            </div>

            <div class="row"> <q-btn class=" col-6 q-ma-sm" type="submit" label="Save project" color="primary"
                    :disable="isLoading" />
            </div>
        </q-form>
    </q-page>
...
export default {
    ...
    methods: {
        ...
        async onSubmit() {
            ...
            try {
                const response = await axios.put(`http://localhost:8000/api/projects/${this.projectId}/`, this.project);
